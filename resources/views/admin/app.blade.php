        ...
        <div class="container">
            ...
            <ul class="navbar-nav navbar-sidenav h-auto" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="الأدوار">
                    <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseRoles"
                        data-parent="#exampleAccordion">
                        <i class="fa fa-fw fa-wrench"></i>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapsePages">
                        ...
                        <li>
                            <a href="{{ route('pages.create') }}"> إضافة صفحة جديدة</a>
                        </li>
                    </ul>
                </li>
            </ul>
    ...
    <footer class="bg-secondary text-center p-4">
        <a href="https://academy.hsoub.com">
            <img style="width:100px"
                src="https://academy.hsoub.com/uploads/monthly_2016_01/SiteLogo-346x108.png.dd3bdd5dfa0e4a7099ebc51f8484032e.png"
                alt="أكاديمية حسوب">
        </a>
    </footer>
    </div>
